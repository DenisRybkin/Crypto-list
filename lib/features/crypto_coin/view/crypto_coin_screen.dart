...
import 'package:flutter_app_example/features/crypto_coin/bloc/crypto_coin_details/crypto_coin_details_bloc.dart';
import 'package:flutter_app_example/features/crypto_coin/widgets/base_card.dart';
...
class _CryptoCoinScreenState extends State<CryptoCoinScreen> {
  final _coinDetailsBloc =
      CryptoCoinDetailsBloc(GetIt.I<BaseCoinsRepository>());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          leading: IconButton(
              icon: const Icon(Icons.arrow_back_ios), onPressed: handleBack),
        ),
